...
void Hamiltonian(arma::cx_mat & H,double time);
arma::cx_mat Ket(std::complex<double> x1 , std::complex<double> x2);
arma::cx_mat Bra(std::complex<double> x1 , std::complex<double> x2);
arma::cx_mat Euler(std::complex<double> & x1,std::complex<double> &x2,double dTime,double dW);
int main(int argc, char **argv)
{
  ...
  arma:: cx_mat A=Euler(Numero,Dos,0.1,0.02);
