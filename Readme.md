...
- [ ] For a single trajectory compute the thermodynamic quantities such as heat ![equation](https://latex.codecogs.com/gif.latex?Q[\rho(t)]) and work ![equation](https://latex.codecogs.com/gif.latex?W[\rho(t)]) at every time.
